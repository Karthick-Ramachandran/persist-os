# Tasks: Skill Generation

## T1: Plan and decision

- Status: Complete.
- Scope: PRD, acceptance, architecture impact, ADR-0004.

## T2: Catalog and rendering

- Status: Complete.
- Scope: Skill catalog and SKILL.md renderer.
- Tests: Catalog and render unit tests.
